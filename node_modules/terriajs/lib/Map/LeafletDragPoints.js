...
LeafletDragPoints.prototype._onMouseDownOnPoint = function(entity) {
    ...
    var dragEntity = this._draggableObjects.entities.values.find(function(dragObjEntity) {
...
LeafletDragPoints.prototype._onMouseUp = function(e) {
    if (this._dragInProgress && Cartesian3.fromDegrees(e.latlng.lng, e.latlng.lat) !== this._originalPosition) {
