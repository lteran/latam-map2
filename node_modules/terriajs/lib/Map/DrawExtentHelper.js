...
var DrawExtentHelper = function (terria, scene, handler, keyboardModifier) {
    ...
    this.active = false;
		this.keyboardModifier = defaultValue(keyboardModifier,  KeyboardEventModifier.SHIFT);
};
...
DrawExtentHelper.prototype.handleRegionStop = function (movement) {
    ...
    this._mouseHandler.removeInputAction(ScreenSpaceEventType.LEFT_UP, this.keyboardModifier);
    this._mouseHandler.removeInputAction(ScreenSpaceEventType.MOUSE_MOVE, this.keyboardModifier);
...
DrawExtentHelper.prototype.handleRegionStart = function (movement) {
    ...
    if (cartesian) {
        ...
        }, ScreenSpaceEventType.LEFT_UP, this.keyboardModifier);
        this._mouseHandler.setInputAction(function (movement) {
            that.handleRegionInter(movement);
        }, ScreenSpaceEventType.MOUSE_MOVE, this.keyboardModifier);
        this._mouseHandler.setInputAction(function (movement) {
            that.handleRegionStop(movement);
...
DrawExtentHelper.prototype.start = function () {
    ...
    }, ScreenSpaceEventType.LEFT_DOWN, this.keyboardModifier);
};
