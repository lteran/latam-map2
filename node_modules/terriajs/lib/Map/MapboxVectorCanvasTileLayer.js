...
var MapboxVectorCanvasTileLayer = L.GridLayer.extend({
    ...
    createTile: function(tilePoint, done) {
        ...
        this._ipReady.then(function() {
            var n = that.imageryProvider.tilingScheme.getNumberOfXTilesAtLevel(tilePoint.z);
            return that.imageryProvider._requestImage(CesiumMath.mod(tilePoint.x, n), tilePoint.y, tilePoint.z, canvas);
