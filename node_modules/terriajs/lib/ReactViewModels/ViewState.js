...
import deprecationWarning from'terriajs-cesium/Source/Core/deprecationWarning';
...
export default class ViewState {
    ...
    viewCatalogItem(item) {
        deprecationWarning('ViewState.viewCatalogItem', 'viewCatalogItem() is deprecated, please use viewCatalogMember() instead.');
        this.viewCatalogMember(item);
    }
