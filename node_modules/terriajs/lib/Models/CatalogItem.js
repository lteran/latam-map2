...
var CatalogItem = function(terria) {
    ...
    /**
     * Gets or sets a flag indicating whether it can ever be displayed using this item's own clock (currentTime, multiplier),
    ...
    knockout.track(this, ['rectangle', 'dataCustodian', 'attribution', 'metadataUrl', 'isEnabled',
        ...
        '_dataUrlType', 'nowViewingCatalogItem', 'useOwnClock']);
