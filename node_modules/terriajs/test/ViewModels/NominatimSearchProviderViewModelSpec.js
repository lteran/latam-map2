...
describe('NominatimSearchProviderViewModel', function() {
    ...
    it('finds catalog items only located in France', function(done) {
        ...
        jasmine.Ajax.stubRequest(new RegExp('nominatim\\.openstreetmap\\.org/search\\?q=place&bounded=1&format=json&countrycodes=fr&limit=2')).andReturn({
            responseText: JSON.stringify([{
                "place_id": "127472260",
                "licence": "Data © OpenStreetMap contributors, ODbL 1.0. http:\/\/www.openstreetmap.org\/copyright",
                "osm_type": "relation",
        ...
        jasmine.Ajax.stubRequest(new RegExp('nominatim\\.openstreetmap\\.org/search\\?q=place&format=json&countrycodes=fr&limit=2')).andReturn({
            responseText: JSON.stringify([{
                "place_id": "127472260",
                "licence": "Data © OpenStreetMap contributors, ODbL 1.0. http:\/\/www.openstreetmap.org\/copyright",
                "osm_type": "relation",
