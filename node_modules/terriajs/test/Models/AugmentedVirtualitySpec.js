...
describe('AugmentedVirtuality', function() {
    ...
    it('check custom matcher', function() {
        ...
        expect({orientation: {roll: 0, pitch: 0, heading: 0}}).closeOrientation({orientation: {roll: 0, pitch: 0, heading: 0}});
        expect({orientation: {         pitch: 0, heading: 0}}).not.closeOrientation({orientation: {roll: 0, pitch: 0, heading: 0}});
        expect({orientation: {roll: 0, pitch: 0, heading: 0}}).not.closeOrientation({orientation: {         pitch: 0, heading: 0}});
        expect({orientation: {roll: 0,           heading: 0}}).not.closeOrientation({orientation: {roll: 0, pitch: 0, heading: 0}});
        expect({orientation: {roll: 0, pitch: 0, heading: 0}}).not.closeOrientation({orientation: {roll: 0,           heading: 0}});
        expect({orientation: {roll: 0, pitch: 0            }}).not.closeOrientation({orientation: {roll: 0, pitch: 0, heading: 0}});
        expect({orientation: {roll: 0, pitch: 0, heading: 0}}).not.closeOrientation({orientation: {roll: 0, pitch: 0            }});
    });
    ...
    it('check device to terria orientation', function() {
        ...
        expect(av._computeTerriaOrientation(  0,    0,    0,    0,    0,    0)).closeOrientation(bod(   0,  -90,    0));

        expect(av._computeTerriaOrientation( 45,    0,    0,    0,    0,    0)).closeOrientation(bod(   0,  -90,  -45));
        expect(av._computeTerriaOrientation(  0,   45,    0,    0,    0,    0)).closeOrientation(bod(   0,  -45,    0));
        expect(av._computeTerriaOrientation(  0,    0,   45,    0,    0,    0)).closeOrientation(bod(  90,  -45,  -90));

        expect(av._computeTerriaOrientation( 45,   15,    0,    0,    0,    0)).closeOrientation(bod(   0,  -75,  -45));
        expect(av._computeTerriaOrientation(-45,   15,    0,    0,    0,    0)).closeOrientation(bod(   0,  -75,   45));
        expect(av._computeTerriaOrientation( 45,  -15,    0,    0,    0,    0)).closeOrientation(bod( 180,  -75,  135));
        expect(av._computeTerriaOrientation(-45,  -15,    0,    0,    0,    0)).closeOrientation(bod( 180,  -75, -135));

        expect(av._computeTerriaOrientation( 45,    0,   15,    0,    0,    0)).closeOrientation(bod(  90,  -75, -135));
        expect(av._computeTerriaOrientation(-45,    0,   15,    0,    0,    0)).closeOrientation(bod(  90,  -75,  -45));
        expect(av._computeTerriaOrientation( 45,    0,  -15,    0,    0,    0)).closeOrientation(bod( -90,  -75,   45));
        expect(av._computeTerriaOrientation(-45,    0,  -15,    0,    0,    0)).closeOrientation(bod( -90,  -75,  135));

        expect(av._computeTerriaOrientation(  0,   45,   15,    0,    0,    0)).closeOrientation(bod(  14.5, -43.1,  -20.8));
        expect(av._computeTerriaOrientation(  0,  -45,   15,    0,    0,    0)).closeOrientation(bod( 165.5, -43.1, -159.2));
        expect(av._computeTerriaOrientation(  0,   45,  -15,    0,    0,    0)).closeOrientation(bod( -14.5, -43.1,   20.8));
        expect(av._computeTerriaOrientation(  0,  -45,  -15,    0,    0,    0)).closeOrientation(bod(-165.5, -43.1,  159.2));

        expect(av._computeTerriaOrientation( 45,   15,    5,    0,    0,    0)).closeOrientation(bod(  18.0, -74.2,  -63.7));
        expect(av._computeTerriaOrientation(-45,   15,    5,    0,    0,    0)).closeOrientation(bod(  18.0, -74.2,   26.3));
        expect(av._computeTerriaOrientation( 45,  -15,    5,    0,    0,    0)).closeOrientation(bod( 162.0, -74.2,  153.7));
        expect(av._computeTerriaOrientation(-45,  -15,    5,    0,    0,    0)).closeOrientation(bod( 162.0, -74.2, -116.3));
        expect(av._computeTerriaOrientation( 45,   15,   -5,    0,    0,    0)).closeOrientation(bod( -18.0, -74.2,  -26.3));
        expect(av._computeTerriaOrientation(-45,   15,   -5,    0,    0,    0)).closeOrientation(bod( -18.0, -74.2,   63.7));
        expect(av._computeTerriaOrientation( 45,  -15,   -5,    0,    0,    0)).closeOrientation(bod(-162.0, -74.2,  116.3));
        expect(av._computeTerriaOrientation(-45,  -15,   -5,    0,    0,    0)).closeOrientation(bod(-162.0, -74.2, -153.7));
        ...
        expect(av._computeTerriaOrientation(  0,    0,    0,   90,    0,    0)).closeOrientation(bod(  90,  -90,    0));

        expect(av._computeTerriaOrientation( 45,    0,    0,   90,    0,    0)).closeOrientation(bod(  90,  -90,  -45));
        expect(av._computeTerriaOrientation(  0,   45,    0,   90,    0,    0)).closeOrientation(bod(  90,  -45,    0));
        expect(av._computeTerriaOrientation(  0,    0,   45,   90,    0,    0)).closeOrientation(bod( 180,  -45,  -90));

        expect(av._computeTerriaOrientation( 45,   15,    0,   90,    0,    0)).closeOrientation(bod(  90,  -75,  -45));
        expect(av._computeTerriaOrientation(-45,   15,    0,   90,    0,    0)).closeOrientation(bod(  90,  -75,   45));
        expect(av._computeTerriaOrientation( 45,  -15,    0,   90,    0,    0)).closeOrientation(bod( -90,  -75,  135));
        expect(av._computeTerriaOrientation(-45,  -15,    0,   90,    0,    0)).closeOrientation(bod( -90,  -75, -135));

        expect(av._computeTerriaOrientation( 45,    0,   15,   90,    0,    0)).closeOrientation(bod( 180,  -75, -135));
        expect(av._computeTerriaOrientation(-45,    0,   15,   90,    0,    0)).closeOrientation(bod( 180,  -75,  -45));
        expect(av._computeTerriaOrientation( 45,    0,  -15,   90,    0,    0)).closeOrientation(bod(   0, -75,   45));
        expect(av._computeTerriaOrientation(-45,    0,  -15,   90,    0,    0)).closeOrientation(bod(   0,  -75,  135));

        expect(av._computeTerriaOrientation(  0,   45,   15,   90,    0,    0)).closeOrientation(bod( 104.5, -43.1,  -20.8));
        expect(av._computeTerriaOrientation(  0,  -45,   15,   90,    0,    0)).closeOrientation(bod(-104.5, -43.1, -159.2));
        expect(av._computeTerriaOrientation(  0,   45,  -15,   90,    0,    0)).closeOrientation(bod(  75.5, -43.1,   20.8));
        expect(av._computeTerriaOrientation(  0,  -45,  -15,   90,    0,    0)).closeOrientation(bod( -75.5, -43.1,  159.2));
        ...
        expect(av._computeTerriaOrientation( 45,    0,    0,  -90,    0,    0)).closeOrientation(bod( -90,  -90,  -45));
        expect(av._computeTerriaOrientation(  0,   45,    0,  -90,    0,    0)).closeOrientation(bod( -90,  -45,    0));
        expect(av._computeTerriaOrientation(  0,    0,   45,  -90,    0,    0)).closeOrientation(bod(   0,  -45,  -90));
        ...
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,    10,    5)).closeOrientation(bod(   0,  -60,  -30));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,    10,    5)).closeOrientation(bod(   0,  -60,   60));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,    10,    5)).closeOrientation(bod( 180,  -60,  150));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,    10,    5)).closeOrientation(bod( 180,  -60, -120));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,    10,   -5)).closeOrientation(bod(   0,  -60,  -40));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,    10,   -5)).closeOrientation(bod(   0,  -60,   50));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,    10,   -5)).closeOrientation(bod( 180,  -60,  140));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,    10,   -5)).closeOrientation(bod( 180,  -60, -130));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,   -10,    5)).closeOrientation(bod(   0,  -60,  -50));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,   -10,    5)).closeOrientation(bod(   0,  -60,   40));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,   -10,    5)).closeOrientation(bod( 180,  -60,  130));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,   -10,    5)).closeOrientation(bod( 180,  -60, -140));
        ...
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,   100,    5)).closeOrientation(bod(   0,  -60,   60));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,   100,    5)).closeOrientation(bod(   0,  -60,  150));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,   100,    5)).closeOrientation(bod( 180,  -60, -120));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,   100,    5)).closeOrientation(bod( 180,  -60,  -30));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,   100,   -5)).closeOrientation(bod(   0,  -60,   50));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,   100,   -5)).closeOrientation(bod(   0,  -60,  140));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,   100,   -5)).closeOrientation(bod( 180,  -60,  230));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,   100,   -5)).closeOrientation(bod( 180,  -60,  -40));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,  -100,    5)).closeOrientation(bod(   0,  -60, -140));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,  -100,    5)).closeOrientation(bod(   0,  -60,  -50));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,  -100,    5)).closeOrientation(bod( 180,  -60,   40));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,  -100,    5)).closeOrientation(bod( 180,  -60, -230));
        ...
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,    10,  115)).closeOrientation(bod(   0,  -60,   80));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,    10,  115)).closeOrientation(bod(   0,  -60,  170));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,    10,  115)).closeOrientation(bod( 180,  -60, -100));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,    10,  115)).closeOrientation(bod( 180,  -60,  -10));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,    10, -115)).closeOrientation(bod(   0,  -60, -150));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,    10, -115)).closeOrientation(bod(   0,  -60,  -60));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,    10, -115)).closeOrientation(bod( 180,  -60,   30));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,    10, -115)).closeOrientation(bod( 180,  -60,  120));
        expect(av._computeTerriaOrientation( 45,   30,    0,    0,   -10,  115)).closeOrientation(bod(   0,  -60,   60));
        expect(av._computeTerriaOrientation(-45,   30,    0,    0,   -10,  115)).closeOrientation(bod(   0,  -60,  150));
        expect(av._computeTerriaOrientation( 45,  -30,    0,    0,   -10,  115)).closeOrientation(bod( 180,  -60, -120));
        expect(av._computeTerriaOrientation(-45,  -30,    0,    0,   -10,  115)).closeOrientation(bod( 180,  -60,  -30));
...
describeIfSupportsWebGL('AugmentedVirtuality tests that require WebGL', function() {
    var container;
    var widget;
    var cesium;
    var terria;
