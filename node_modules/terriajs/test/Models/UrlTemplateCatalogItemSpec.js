...
describe('UrlTemplateCatalogItem', function() {
    ...
    it('is derived from ImageryLayerCatalogItem', function() {
        expect(urlTemplateCatalogItem instanceof ImageryLayerCatalogItem).toBe(true);
    });

    it('creates Cesium imagery provider correctly', function(done) {
        urlTemplateCatalogItem.url = '{s}.tiles.example.com/mylayer/{z}/{x}/{y}.png';
        ...
        urlTemplateCatalogItem.load().then(function() {
