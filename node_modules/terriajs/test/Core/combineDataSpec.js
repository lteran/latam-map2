...
describe('combineData', function() {
    ...
    it('works with two sorted numerical arrays', function() {
        ...
        var target = [[1, 5, null], [2, null, 12], [3, 7, null], [4, null, 8], [6, 10, 5], [8, null, 7], [9, -3, null]];
    ...
    it('works with two date arrays', function() {
        var data1 = [[new Date('2015-03-01'), 5], [new Date('2015-03-02'), 7], [new Date('2015-03-04'), 10]];
        var data2 = [[new Date('2015-02-28'), 12], [new Date('2015-03-02'), 8]];
        var target = [[new Date('2015-02-28'), null, 12], [new Date('2015-03-01'), 5, null], [new Date('2015-03-02'), 7, 8], [new Date('2015-03-04'), 10, null]];
        var combined = combineData([data1, data2]);
        expect(combined).toEqual(target);
    });
