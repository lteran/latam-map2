...
describe('formatNumberForLocale', function() {
    ...
    describe('with Intl', function() {
        ...
        it('does not truncate decimals or group 000s by default', function() {
            expect(formatNumberForLocale(6789123.4567891)).toBe('6789123' + decimalPoint + '4567891');
            expect(formatNumberForLocale(-6789123.4567891)).toBe('-6789123' + decimalPoint + '4567891');
        });
        ...
        it('useGrouping works', function() {
            expect(formatNumberForLocale(-6789123.4, {useGrouping: true})).toBe('-6' + separator + '789' + separator + '123' + decimalPoint + '4');
            expect(formatNumberForLocale(-6789123.3678, {useGrouping: true, maximumFractionDigits: 1})).toBe('-6' + separator + '789' + separator + '123' + decimalPoint + '4');
        });

        it('style percent works', function() {
            expect(formatNumberForLocale(0.934, {style: 'percent'})).toBe('93' + decimalPoint + '4%');
            expect(formatNumberForLocale(1.555555, {style: 'percent'})).toBe('155' + decimalPoint + '5555%');
            expect(formatNumberForLocale(-0.4, {style: 'percent'})).toContain('-40'); // Allow either -40% or -40.0%
            expect(formatNumberForLocale(0.93456, {style: 'percent', maximumFractionDigits: 2})).toContain('93' + decimalPoint + '46');  // IE11 produces 93.46 % with a space.
        });
